...
Une des questions légitimes sur la mise en places des GLOSA est de connaitre ses limites en fonction des indices de performance et du comportement du conducteur. Ainsi dans cette partie ouverte, il est demandé de:
 ...
 - <b>Q3: </b> A demande fixe et taux de VAC fixe, évaluer l'impact du GLOSA pour différentes valeurs du facteur de vitesse du conducteur lors de la communication du GLOSA. Par exemple [1,1.1,1.2,1.3,1.4,1.5] 

Il serait bien dans cette partie de faire des quadrillages avec dans l'ordonnée et l'abscisse les distances et les facteurs de vitesse
